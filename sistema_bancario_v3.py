...
class Conta:
    ...
    def sacar(self, valor):
        ...
        if excedeu_saldo:
            print("Falha no sistema, você não tem saldo suficiente.")
    ...
    def depositar(self ,valor):
        if valor > 0:
            ...
            print("Falhou, valor informado é inválido .")
            return False
        return True
...
class ContaCorrente(Conta):
    ...
    def sacar(self, valor):
        ...
        if execedeu_limite:
            print("Operação falhou, valor do saque excedido (R$ 500,00) por transação.")
...
def depositar(clientes):
    ...
    if not cliente:
        ...
        return
    valor = float(input("Informe o valor do déposito : R$ "))
...
def criar_cliente(clientes):
    ...
    if cliente:
        print("Já eiste um cliente com esse CPF !")
        return
...
def main():
    ...
    while True:
        ...
        if opcao == "d":
            ...
            print("Operação inválida, por favor selecione novamente a operação válida desejada.")
